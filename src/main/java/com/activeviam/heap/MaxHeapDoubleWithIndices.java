...
public class MaxHeapDoubleWithIndices implements IPrimitiveIterator {
	 ...
	 */
	public MaxHeapDoubleWithIndices(int capacity) {
	...
	public double poll() {
		...
		final double result = queue[0];
		final double last = queue[size];
