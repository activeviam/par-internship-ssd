 ...
 *
 * <p>Its fields can have numerics values ({@link #getValues()} stored as doubles. The other types
 * of fields will be stored as ints ({@link #getAttributes()}) (we will suppose that the encoding of
